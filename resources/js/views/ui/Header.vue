<template>
    <header class="header">
        <div
            class="col-xl-12 d-flex justify-content-between align-items-center flex-wrap pt-3 pb-3"
        >
            ...
            <div>
                <h5 class="d-flex">
                    Добро пожаловать на платформу, {{ authUser.name }} !
                </h5>
            </div>
...
export default {
    ...
    methods: {
        ...
        tiktak() {
            ...
            // elm1.innerHTML = info;
            this.time.innerHTML =
                "Текущее время: " + myHours + ":" + myMinutes + ":" + mySec;
