              ...
              <div class="card card_course">
                ...
                <div class="card-body">
                  ...
                  <div class="card__buttons d-flex justify-content-between">
                    ...
                    >
                        <my-button class="btn btn-outline-success"
                          >Открыть
...
<!-- :to="`/course-id${this.$route.params.id}/lesson-id${lesson.id}/edit`" -->
                    ...
                    <router-link 
                      ...
                      v-if="authUser.role == 'Master'"
                    >
                        <my-button class="btn btn-outline-warning"
                          >Редактировать
                    ...
                    <router-link :to="'/'"
                      v-if="authUser.role == 'Master'">
                        <my-button class="btn btn-outline-danger"
                          >Архивироавать
