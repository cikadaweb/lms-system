    ...
    <div class="row pt-3">
      <div class="col-xl-12">
        ...
        <div class="row">
          ...
          class="dashboard-panel-filter col-xl-12 d-flex justify-content-between flex-wrap pt-3">
        ...
        <div v-else class="dashboard-panel-courses row mt-5">
          <div class="col-xl-6 col-sm-12 pb-3" v-for="course in getCourses" :key="course.id">
